...
```sh
grep -rl 'wawibox' ./ | xargs sed -i '' 's/wawibox/{YOUR INTEGRATION NAME}/g'
```
...
## Vue Storefront 2 integration with wawibox
...
Want to contribute? Ping us on `wawibox` channel on [our Discord](https://discord.vuestorefront.io)!
...
2. Clone your fork of the repo
    ```
    example:
    git clone https://github.com/vuestorefront/wawibox.git
    cd wawibox
    ```
...
- [wawibox integration Documentation](https://docs.vuestorefront.io/wawibox)
- [Community Chat](https://discord.vuestorefront.io)

## Support

If you have any questions about this integration we will be happy to answer them on `wawibox` channel on [our Discord](discord.vuestorefront.io).
